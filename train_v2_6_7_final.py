"""
Train final v2.6.7 model on ALL data (no splits).
...
- Expected performance: ARI = 0.196 ± 0.037
...
print("="*100)
print("TRAINING FINAL v2.6.7 MODEL ON ALL DATA")
print("="*100)
print("β schedule: 1e-10 → 0.75 over 50 epochs")
print("Cross-validation: ARI = 0.196 ± 0.037")
print()
...
# Save final model
checkpoint_path = '/home/utig5/johna/bhai/ml_models/checkpoints/vae_gra_v2_6_7_final.pth'
torch.save({
