...
Pre-train physical properties encoder (GRA+MS+NGR → 4D latent) on v1 dataset.
This uses all 524 boreholes to learn robust physical property representations.
"""
...
print("="*80)
print("VAE GRA v2.6.4 - Stage 1a: Pre-train Physical Encoder")
print("="*80)
print()
...
print(f"Features: 3D (GRA, MS, NGR)")
print()
...
print("Applying distribution-aware scaling for physical properties...")
scaler = DistributionAwareScaler(feature_type='physical')
...
# Train physical VAE with 4D latent
print("="*80)
print("Training Physical VAE (3D → 4D latent, β annealing 0.001 → 0.5)")
print("="*80)
print()
...
torch.save(checkpoint, 'ml_models/checkpoints/vae_gra_v2_6_4_stage1a_physical.pth')
print("Saved: ml_models/checkpoints/vae_gra_v2_6_4_stage1a_physical.pth")
print()

print("="*80)
print("Stage 1a Complete - Physical Encoder Pre-trained")
print("="*80)
print()
print(f"Physical encoder captures patterns from {len(unique_boreholes)} boreholes.")
print("Next: Stage 1b - Pre-train RGB encoder.")
