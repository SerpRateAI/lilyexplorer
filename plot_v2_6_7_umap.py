...
# -*- coding: utf-8 -*-
"""
UMAP Projection for VAE v2.6.7 Model
...
class VAE(nn.Module):
    """VAE v2.6.7 Architecture - Single Decoder with β annealing"""
...
def create_umap_projection(z, cluster_labels, lithologies, gmm, ari):
    ...
    ax.set_title(
        f'VAE v2.6.7: UMAP Projection of 10D Latent Space\n'
    ...
    plt.tight_layout()
    output_file = 'v2_6_7_umap_projection.png'
...
def create_lithology_colored_umap(z_umap, lithologies):
    ...
    ax.set_ylabel('UMAP Dimension 2', fontsize=14, weight='bold')
    ax.set_title(
        'VAE v2.6.7: UMAP Projection Colored by True Lithology\n'
    ...
    plt.tight_layout()
    output_file = 'v2_6_7_umap_by_lithology.png'
    plt.savefig(output_file, dpi=300, bbox_inches='tight')
...
if __name__ == "__main__":
    print("="*70)
    print("VAE v2.6.7: UMAP Projection Analysis")
    print("="*70)
    ...
    print("="*70)
    print(f"\nGenerated files:")
    print("  - v2_6_7_umap_projection.png (GMM clusters with lithology labels)")
    print("  - v2_6_7_umap_by_lithology.png (colored by true lithology)")
